...
## Annotation
`ptairMS` propose a putative annotation based on the database described in [@de_lacy_costello_review_2014],with the annotateVOC function. Applied to an expression set, it write in the features metadata all possible formulas, names foun, and the isotopes for nuclide C13, O17 and O18. 
