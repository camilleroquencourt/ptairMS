...
## Checking raw data andsetting parameters
...
expirationLimit <- timeLimits(sampleRaw,fracMaxTIC =  0.5,plotDel = T)
```

Example of expirations detetcion at `fracMaxTIC = 0.9` 
```{r timelimit2, echo=FALSE}
expirationLimit <- timeLimits(sampleRaw,fracMaxTIC =  0.9,plotDel = T)
```
